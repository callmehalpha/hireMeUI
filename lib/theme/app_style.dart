...
class AppStyle {
  static TextStyle txtPlusJakartaSansBold18Gray902 = TextStyle(
  ...
  static TextStyle txtPlusJakartaSansSemiBold14Gray50 = TextStyle(
    color: ColorConstant.gray50,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtPlusJakartaSansSemiBold16Gray905 = TextStyle(
    color: ColorConstant.gray905,
    fontSize: getFontSize(
      16,
    ),
